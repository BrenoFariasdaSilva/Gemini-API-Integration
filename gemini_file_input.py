...
def read_input_file(file_path=INPUT_FILE):
	...
	if not os.path.exists(file_path):
		print(f"{BackgroundColors.RED}Input file {BackgroundColors.CYAN}{file_path}{BackgroundColors.RED} not found.{Style.RESET_ALL}")
		sys.exit(1) # Exit the program
...
def main():
	...
	print(f"{BackgroundColors.BOLD}{BackgroundColors.GREEN}Program finished.{Style.RESET_ALL}", end="\n\n") # Output the end of the program message
